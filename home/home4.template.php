<div class="col-xs-12 col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main" ng-controller="home4Controller">
	<div class="row" id="top">
		<ol class="breadcrumb">
			<li>
				<i class="fa fa-gamepad" aria-hidden="true"></i> &nbsp;
				PSP Homebrews Lister ({{brews.length}} homebrews available)
			</li>
		</ol>
		<ol class="breadcrumb">
		...
		<div ng-repeat="brew in brews | filter: filterBrews(field) | orderBy: sort_by" class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
			<div class="panel panel-widget ">
				<div class="row no-padding">
					<div class="col-md-3">
						<center><a href="#/info/{{brew.id}}"><img class="icon" ng-src="icons/{{brew.icon}}" /></a></center>
					</div>
					<div class="col-md-9">
